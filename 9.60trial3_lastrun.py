...
expName = '9.60trial3'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/alexisyang/Desktop/9.60trial3/9.60trial3_lastrun.py',
...
text = visual.TextStim(win=win, name='text',
    ...
    font='Open Sans',
    pos=(0, 0), height=16.0, wrapWidth=None, ori=0.0, 
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('no_quotes.xlsx'),
